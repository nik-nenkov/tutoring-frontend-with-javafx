...
public class RootViewPresenter implements Initializable {
  ...
  @FXML private TableView<BookEntity> bookTableView;
  @FXML private TableColumn<BookEntity, String> idColumn;
  @FXML private TableColumn<BookEntity, String> titleColumn;
  @FXML private TableColumn<BookEntity, String> isbnColumn;
  @FXML private TableColumn<BookEntity, Timestamp> addedOnColumn;

  @FXML private TextField entriesPerPageTextField;
  ...
  private void loadBookEntityList() {
    bookEntityList =
        bookJpaRepository.findAll(PageRequest.of(pageNumber(), entriesPerPage())).getContent();
  }
